...
export default class LichessClient extends EventEmitter {    
     ...
     * @type {String}
     */
    static BASE_HOST = ldev ? "127.0.0.1:9663" : "lichess.org"

    /**
     * The base lichess URL to use.
     * @type {String}
     */
    static BASE_URL = ldev ? "http://127.0.0.1:9663" : "https://lichess.org"

    static BASE_OAUTH = ldev ? "http://127.0.0.1:0000" : "https://oauth.lichess.org"

    /**
     * The base lichess API URL to use.
     * @type {String}
     */
    static BASE_API = ldev ? "http://127.0.0.1:9663/api" : "https://lichess.org/api"
